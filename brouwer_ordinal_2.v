...
Definition 加算@{ i | }
  ...
  :=
    ...
    四段階のブラウワー順序数.場合分け@{ i }
      四段階のブラウワー順序数@{ i }
      ( fun a_ゼロ段階の列 : ゼロ段階のブラウワー順序数@{ i } -> 四段階のブラウワー順序数@{ i } => x )
      四段階のブラウワー順序数.一段階の構築子@{ i }
      四段階のブラウワー順序数.二段階の構築子@{ i }
      四段階のブラウワー順序数.三段階の構築子@{ i }
.

Fail Definition オメガ冪@{ i | }
  : 四段階のブラウワー順序数@{ i } -> 四段階のブラウワー順序数@{ i }
  :=
    fun x : 四段階のブラウワー順序数@{ i } =>
    四段階のブラウワー順序数.場合分け@{ i }
      四段階のブラウワー順序数@{ i }
      ( fun a_ゼロ段階の列 : ゼロ段階のブラウワー順序数@{ i } -> 四段階のブラウワー順序数@{ i } => 一@{ i } )
      (
        fun a_一段階の列 : 一段階のブラウワー順序数@{ i } -> 四段階のブラウワー順序数@{ i } =>
