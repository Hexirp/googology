...
Definition 順序数崩壊関数の終域@{ i | } : 順序数崩壊関数の添字@{ i } -> Type@{ i }
  :=
    ...
    match
      添字
    with
      一番目のオメガと等しい添字 => 三段階のブラウワー順序数@{ i }
      |
      二番目のオメガと等しい添字 => 四段階のブラウワー順序数@{ i }
    end
.

Definition 順序数崩壊関数@{ i | }
  : forall 添字 : 順序数崩壊関数の添字@{ i } , 五段階のブラウワー順序数@{ i } -> 順序数崩壊関数の終域@{ i } 添字
  :=
    fix a ( 添字 : 順序数崩壊関数の添字@{ i } ) ( x : 五段階のブラウワー順序数@{ i } ) { struct x }
      : 順序数崩壊関数の終域@{ i } 添字
      :=
        match
          x
        with
          五段階のブラウワー順序数.ゼロ段階の構築子 x_ゼロ段階の列
          =>
            match
              添字
            as
            ...
            return
              順序数崩壊関数の終域@{ i } 添字_
            with
              一番目のオメガと等しい添字 => 三段階のブラウワー順序数.後者関数@{ i } 三段階のブラウワー順序数.ゼロ@{ i }
              |
              二番目のオメガと等しい添字 => 四段階のブラウワー順序数.一番目のオメガ@{ i }
            end
          |
          五段階のブラウワー順序数.一段階の構築子 x_一段階の列
          =>
            match
              添字
            as
            ...
            with
              ...
              =>
              三段階のブラウワー順序数.乗算@{ i }
                ( a 一番目のオメガと等しい添字@{ i } ( x_一段階の列 一段階のブラウワー順序数.ゼロ@{ i } ) )
                三段階のブラウワー順序数.オメガ@{ i }
              |
              二番目のオメガと等しい添字
              =>
              四段階のブラウワー順序数.乗算@{ i }
                ( a 二番目のオメガと等しい添字@{ i } ( x_一段階の列 一段階のブラウワー順序数.ゼロ@{ i } ) )
                四段階のブラウワー順序数.オメガ@{ i }
            end
          |
          五段階のブラウワー順序数.二段階の構築子 x_二段階の列
          =>
            match
              添字
            as
            ...
            with
              ...
              =>
              三段階のブラウワー順序数.二段階の構築子@{ i }
                ( fun y : 二段階のブラウワー順序数@{ i } => a 一番目のオメガと等しい添字@{ i } ( x_二段階の列 y ) )
              |
              二番目のオメガと等しい添字
              =>
              四段階のブラウワー順序数.二段階の構築子@{ i }
                ( fun y : 二段階のブラウワー順序数@{ i } => a 二番目のオメガと等しい添字@{ i } ( x_二段階の列 y ) )
            end
          |
          五段階のブラウワー順序数.三段階の構築子 x_三段階の列
          =>
            match
              添字
            as
            ...
            with
              ...
              =>
              三段階のブラウワー順序数.繰り返し適用の強上限@{ i }
                ( a 一番目のオメガと等しい添字@{ i } ( x_三段階の列 三段階のブラウワー順序数.オメガ@{ i } ) )
                ( fun y : 三段階のブラウワー順序数@{ i } => a 一番目のオメガと等しい添字@{ i } ( x_三段階の列 y ) )
              |
              二番目のオメガと等しい添字
              =>
              四段階のブラウワー順序数.三段階の構築子@{ i }
                ( fun y : 三段階のブラウワー順序数@{ i } => a 二番目のオメガと等しい添字@{ i } ( x_三段階の列 y ) )
            end
          |
          五段階のブラウワー順序数.四段階の構築子 x_四段階の列
          =>
            match
              添字
            as
            ...
            with
              ...
              a
                ...
                (
                  x_四段階の列
                    (
                      四段階のブラウワー順序数.繰り返し適用の強上限@{ i }
                        (
                          a
                            二番目のオメガと等しい添字@{ i }
                            ( x_四段階の列 四段階のブラウワー順序数.オメガ@{ i } )
                        )
                        (
                          fun y : 四段階のブラウワー順序数@{ i } =>
                          a 二番目のオメガと等しい添字@{ i } ( x_四段階の列 y )
                        )
                    )
                )
              |
              ...
              =>
              四段階のブラウワー順序数.繰り返し適用の強上限@{ i }
                ( a 二番目のオメガと等しい添字@{ i } ( x_四段階の列 四段階のブラウワー順序数.オメガ@{ i } ) )
                ( fun y : 四段階のブラウワー順序数@{ i } => a 二番目のオメガと等しい添字@{ i } ( x_四段階の列 y ) )
            end
          end
.
